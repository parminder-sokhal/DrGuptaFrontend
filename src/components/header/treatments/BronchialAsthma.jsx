...
const data = {
  bgImage: "/img/BronchialAsthma.jpeg", // You can replace this with an asthma-related image
  sidebarLinks: [
    ...
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="px-10 lg:px-40 py-10">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">
          Bronchial Asthma Treatment: A Complete Guide
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-3/4 space-y-6 text-gray-700">
            ...
            <p>
              Bronchial asthma is a chronic respiratory condition where the airways become
              inflamed and narrowed, making it hard to breathe. It affects both children and
              adults and can vary from mild to severe.
            </p>

            <h2 className="font-bold text-xl mt-6">Causes & Triggers</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>Allergens: Pollen, dust mites, mold, pet dander, cockroach droppings</li>
              <li>Air pollution: Smoke, fumes, cold air</li>
              <li>Respiratory infections: Cold, flu</li>
              <li>Exercise</li>
              <li>Stress or strong emotions</li>
              <li>Certain medications: Aspirin, NSAIDs, beta-blockers</li>
              <li>Food preservatives: Sulfites in processed food, wine, etc.</li>
